import { symphonyHtml } from "../symphony-iv/symphony-html";

const figmaAssets = {
  hero: "/images/circulo-figma/hero.png",
  mobileHero: "/images/circulo-figma/hero.png",
  collection: "/images/circulo-figma/collection.png",
  thumbnails: [
    "/images/circulo-figma/thumb-6.png",
    "/images/circulo-figma/thumb-3.png",
    "/images/circulo-figma/thumb-1.png",
    "/images/circulo-figma/thumb-2.png",
    "/images/circulo-figma/thumb-4.png",
    "/images/circulo-figma/thumb-5.png",
  ],
  ...
  gallery: [
    "/images/circulo-figma/thumb-6.png",
    "/images/circulo-figma/gallery-3.png",
    "/images/circulo-figma/gallery-1.png",
    "/images/circulo-figma/gallery-2.png",
    "/images/circulo-figma/gallery-4.png",
    "/images/circulo-figma/gallery-5.png",
  ],
  family: [
    "/images/circulo-figma/family-1.png",
    "/images/circulo-figma/family-2.png",
    "/images/circulo-figma/family-3.png",
    "/images/circulo-figma/family-4.png",
  ],
};

const figmaCss = `<style id="circulo-figma-refresh">
...
.product-page .product-stage{position:relative}.product-page .product-stage>img.stage-outgoing{position:absolute;z-index:2;inset:0;pointer-events:none;opacity:1;transform:scale(1);transition:opacity 250ms var(--ease-out),filter 250ms var(--ease-out)!important}.product-page .product-stage>img.stage-outgoing.is-leaving{opacity:0;filter:blur(2px)}
.product-page .product-stage>img.stage-incoming{opacity:0!important;filter:blur(2px);transition:opacity 250ms var(--ease-out),filter 250ms var(--ease-out)!important}.product-page .product-stage>img.stage-incoming.is-arrived{opacity:1!important;filter:blur(0)}
.product-page .product-thumbs{overflow-x:auto!important;overflow-y:hidden!important;width:100%!important;transform:none!important;transition:none!important;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch;scroll-snap-type:x mandatory;scrollbar-width:none}
.product-page .product-thumbs::-webkit-scrollbar,.product-page .related-track::-webkit-scrollbar{display:none}
.product-page .product-thumbs button{scroll-snap-align:start;scroll-snap-stop:always;flex:0 0 auto}
.product-page .product-thumbs button{position:relative;transition:transform 140ms var(--ease-out),opacity 150ms var(--ease-out)!important}.product-page .product-thumbs button:after{content:"";position:absolute;inset:0;border:1px solid #111;opacity:0;pointer-events:none;transition:opacity 180ms var(--ease-out)}.product-page .product-thumbs button.active{transform:scale(1.03)}.product-page .product-thumbs button.active:after{opacity:1}.product-page .gallery-arrow,.product-page .related-arrow{transition:transform 140ms var(--ease-out),opacity 150ms ease}
...
.product-page .gallery-arrow[aria-disabled="true"],.product-page .related-arrow[aria-disabled="true"]{opacity:.3!important;pointer-events:none!important}
...
@media (hover:hover) and (pointer:fine){
 ...
 .product-page .product-thumbs button:hover{transform:scale(1.03)}.product-page .combination-swatches button:hover{transform:scale(1.03)}.product-page .combination-swatches button:not(.active):hover:before{opacity:.55;transform:translateX(-50%) scale(1)}
...
@media (prefers-reduced-motion:no-preference){
 .product-page .product-enquire:active,.product-page .combination-swatches button:active,.product-page .size-options button:active,.product-page .product-thumbs button:active,.product-page .gallery-arrow:active,.product-page .related-arrow:active{transform:scale(.97)!important;transition:transform 140ms var(--ease-out)!important}
 .product-page .size-options.motion-segmented{position:relative;isolation:isolate;--segment-x:0px;--segment-w:57px}
 .product-page .size-options.motion-segmented:before{content:"";position:absolute;z-index:0;left:0;top:0;width:var(--segment-w);height:100%;border-radius:2px;background:#050505;transform:translate3d(var(--segment-x),0,0);transition:transform 200ms var(--ease-out)}
 .product-page .size-options.motion-segmented button:nth-child(n){position:relative;z-index:1;background:transparent!important;transition:transform 140ms var(--ease-out)!important}
 .product-page .size-options.motion-segmented button.active{border-color:transparent!important;color:#fff!important}
}
...
.product-page .size-options{display:flex!important;gap:7px!important}.product-page .size-options button:nth-child(n){display:block!important;min-width:57px!important}.product-page .size-options button:not(.active){border:1px solid #999!important;background:#fff!important;color:#555!important}
.product-page .related-track>a{flex-basis:384px!important;min-width:384px!important}.product-page .related-track>a:nth-child(n){display:block!important}.product-page .related-track>a>img{height:362px!important;object-fit:cover!important}
.product-page .spec-code{display:inline-block!important;margin-left:7px;margin-right:0;color:#c0c0c0;font:700 8px/1 Inter,sans-serif;font-style:normal!important;vertical-align:super}
.product-page .spec-values{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.product-page .spec-values.five{grid-template-columns:repeat(5,minmax(0,1fr))}.product-page .spec-values.two{grid-template-columns:repeat(2,minmax(0,1fr))}
.product-page .spec-values>span{display:block!important}.product-page .collection-band>div>span{max-width:425px}
.product-page .circulo-size-scroll{width:100%;box-sizing:border-box;margin:38px 0 34px;border:.5px solid #aaa;overflow-x:auto;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch}
.product-page .circulo-size-table{min-width:100%}
.product-page .circulo-size-table .circulo-matrix-row{display:grid!important;grid-template-columns:282px minmax(0,1fr)!important;align-items:center;box-sizing:border-box;min-height:48px;margin:0!important;padding:0 28px!important;border:0!important;border-bottom:1px solid #e2e2e2!important}
.product-page .circulo-size-table .circulo-matrix-row:last-child{border-bottom:0!important}
.product-page .circulo-size-table .spec-values{display:grid!important;grid-template-columns:repeat(3,minmax(130px,1fr))!important;gap:24px!important;align-items:center}
.product-page .circulo-size-table .spec-values>span{white-space:nowrap}
.product-page .circulo-size-scroll~p{grid-template-columns:310px 1fr!important;margin:0!important;padding:13px 0!important;border-top:0!important;border-left:0!important;border-right:0!important;border-bottom:1px solid #e2e2e2!important}
.product-page .circulo-size-scroll~p:last-child{border-bottom:0!important}
.product-page .related-track>a:after{width:70px!important;background:radial-gradient(circle at 6px 6px,#cda766 0 5px,transparent 5.5px),radial-gradient(circle at 25px 6px,#202020 0 5px,transparent 5.5px),radial-gradient(circle at 44px 6px,#a74b2d 0 5px,transparent 5.5px),radial-gradient(circle at 63px 6px,#aaa 0 5px,transparent 5.5px)!important}
.product-page .related-arrow{top:181px!important}
@media(max-width:600px){.product-page .spec-values,.product-page .spec-values.five{grid-template-columns:1fr!important;gap:5px}.product-page .size-options button{min-width:46px!important}.product-page .related-track>a{flex-basis:calc((100vw - 54px)/2)!important;min-width:calc((100vw - 54px)/2)!important}.product-page .related-track>a>img{height:auto!important;aspect-ratio:302/360}.product-page .circulo-size-scroll{margin:36px 0 30px}.product-page .circulo-size-table{min-width:570px}.product-page .circulo-size-table .circulo-matrix-row{grid-template-columns:110px 1fr!important;padding:0 14px!important}.product-page .circulo-size-table .spec-values{grid-template-columns:repeat(3,130px)!important;gap:18px!important}.product-page .circulo-size-table .spec-code{margin-left:5px!important}.product-page .circulo-size-scroll~p{grid-template-columns:127px 1fr!important;padding:12px 0!important}.product-page .related-arrow{top:calc(50% - 34px)!important}}
...
const figmaDomSync = `<script id="circulo-figma-dom-sync">
(()=>{
 ...
 const specBodyMarkup='<p><b>Category</b><span>Pendant Light</span></p>'+
  '<p><b>Primary Material</b><span>PET (9MM)</span></p>'+
  '<p><b>Primary Finish</b><span>Slate Grey, Grey, Dark Beige, Charcoal, Brown, Terracotta, Merlot, Burnt Orange, Sky Blue, Pacific Blue, Jaisalmer Yellow, Pacific Marble, Red, Maroon, Indigo Blue, Dark Green<small class="figma-spec-note">Wire colour will be white for any fixture having white in the body finish, black canopy for all colours other than white</small></span></p>'+
  '<p><b>Secondary Material</b><span>Aluminium</span></p>'+
  '<p><b>Secondary Finish</b><span>Black</span></p>'+
  '<p><b>Wire Colour</b><span>White, Black</span></p>'+
  '<div class="circulo-size-scroll" role="region" aria-label="Circulo size comparison" tabindex="0"><div class="circulo-size-table">'+
   '<p class="circulo-matrix-row"><b>Size</b><span class="spec-values" data-values="600 mm|600 mm|1200 mm"><span>600 mm <i class="spec-code">60</i></span><span>600 mm <i class="spec-code">60</i></span><span>1200 mm <i class="spec-code">90</i></span></span></p>'+
   '<p class="circulo-matrix-row"><b>Wattage</b><span class="spec-values" data-values="34W|34W|78W"><span>34W</span><span>34W</span><span>78W</span></span></p>'+
   '<p class="circulo-matrix-row"><b>Height</b><span class="spec-values" data-values="250 mm|250 mm|350 mm"><span>250 mm</span><span>250 mm</span><span>350 mm</span></span></p>'+
   '<p class="circulo-matrix-row"><b>Diameter</b><span class="spec-values" data-values="Ø 620 mm|Ø 620 mm|Ø 1220 mm"><span>Ø 620 mm</span><span>Ø 620 mm</span><span>Ø 1220 mm</span></span></p>'+
  '</div></div>'+
  '<p><b>Light source</b><span>LED</span></p>'+
  '<p><b>CCT</b><span class="spec-values five" data-values="2700K|3000K|4000K|5700K|Tunable White 2700K - 5700K"><span>2700K <i class="spec-code">27K</i></span><span>3000K <i class="spec-code">30K</i></span><span>4000K <i class="spec-code">40K</i></span><span>5700K <i class="spec-code">57K</i></span><span>Tunable White 2700K - 5700K <i class="spec-code">TW 27K-57K</i></span></span></p>'+
  '<p><b>Input Voltage</b><span>220V-240V</span></p>'+
  '<p><b>Control</b><span class="spec-values two" data-values="ON-OFF|DALI"><span>ON-OFF <i class="spec-code">OO</i></span><span>DALI <i class="spec-code">DDIM</i></span></span></p>';
 const modal='<div class="figma-enquiry" hidden><div class="figma-enquiry-card" role="dialog" aria-modal="true" aria-labelledby="figma-enquiry-title"><button class="figma-enquiry-close" aria-label="Close enquiry form">×</button><h2 id="figma-enquiry-title">Product Enquiry</h2><p class="figma-enquiry-lead">Tell us about your project, and our team will get back to you shortly.</p><form><div class="figma-enquiry-grid"><input class="full" required placeholder="Name*"><input required placeholder="Mobile number*"><input type="email" required placeholder="Email id*"><select required><option value="">City*</option><option>Mumbai</option><option>Delhi NCR</option><option>Bengaluru</option><option>Other</option></select><input placeholder="Company / Firm Name"><select class="full" required><option value="">I am a*</option><option>Architect</option><option>Interior Designer</option><option>Homeowner</option><option>Other</option></select><textarea class="full" placeholder="Tell us more — Circulo, SYLNC Collection, Pendant Light"></textarea></div><div class="figma-captcha"><i></i> I am not a robot</div><button class="figma-enquiry-submit" type="submit">SEND ENQUIRY</button><p class="figma-enquiry-consent">By submitting this form, you agree to be contacted by <em>Abby Lighting</em> regarding your enquiry.</p></form></div></div>';
 const lightbox='<div class="figma-lightbox" hidden role="dialog" aria-modal="true" aria-label="Product image viewer"><button class="figma-lightbox-close" aria-label="Close image viewer">×</button><button class="figma-lightbox-prev" aria-label="Previous image">‹</button><img alt="Circulo product detail"><button class="figma-lightbox-next" aria-label="Next image">›</button></div>';
 const colourVariants=[
  {name:'Slate Grey',finishA:'#777a7b',finishB:'#777a7b',code:'SLG',colorImageUrl:null},
  {name:'Grey',finishA:'#a2a3a3',finishB:'#a2a3a3',code:'GRY',colorImageUrl:null},
  {name:'Dark Beige',finishA:'#9a8063',finishB:'#9a8063',code:'DBE',colorImageUrl:null},
  {name:'Charcoal',finishA:'#313233',finishB:'#313233',code:'CHR',colorImageUrl:null}
 ];
 const sizeVariants=[['600','60'],['600','60'],['1200','90']];
 let galleryIndex=-1;
 ...
 const setArrowState=(arrow,disabled)=>{if(!arrow)return;arrow.disabled=disabled;arrow.setAttribute('aria-disabled',String(disabled))};
 const updateScrollerArrows=(scroller,prev,next)=>{if(!scroller)return;setArrowState(prev,scroller.scrollLeft<=0);setArrowState(next,scroller.scrollLeft+scroller.clientWidth>=scroller.scrollWidth-1)};
 const carouselBindings=[];
 const bindNativeScroller=(scroller,prev,next)=>{if(!scroller||scroller.dataset.nativeBound)return;scroller.dataset.nativeBound='true';const update=()=>updateScrollerArrows(scroller,prev,next);scroller.addEventListener('scroll',update,{passive:true});carouselBindings.push(update);requestAnimationFrame(update)};
 const itemStep=(scroller,selector)=>{const item=scroller?.querySelector(selector);if(!item)return 0;const gap=parseFloat(getComputedStyle(scroller).gap)||0;return item.getBoundingClientRect().width+gap};
 const scrollOneItem=(scroller,selector,direction)=>{if(!scroller)return;scroller.scrollBy({left:itemStep(scroller,selector)*direction,behavior:prefersReducedMotion()?'auto':'smooth'})};
 const initNativeCarousels=()=>{bindNativeScroller(document.querySelector('.product-thumbs'),document.querySelector('.gallery-prev'),document.querySelector('.gallery-next'));bindNativeScroller(document.querySelector('.related-track'),document.querySelector('.related-prev'),document.querySelector('.related-next'))};
 const syncSizeIndicator=()=>{const group=document.querySelector('.size-options.motion-segmented');const active=group?.querySelector('button.active');if(!group||!active)return;group.style.setProperty('--segment-x',active.offsetLeft+'px');group.style.setProperty('--segment-w',active.offsetWidth+'px')};
 const swapStage=(stage,src)=>{const current=stage.getAttribute('src');if(!current||current===src){stage.src=src;return}const outgoing=stage.cloneNode(true);outgoing.removeAttribute('data-synced');outgoing.className='stage-outgoing';stage.parentElement.insertBefore(outgoing,stage);stage.classList.add('stage-incoming');stage.src=src;requestAnimationFrame(()=>{outgoing.classList.add('is-leaving');stage.classList.add('is-arrived')});setTimeout(()=>{outgoing.remove();stage.classList.remove('stage-incoming','is-arrived')},270)};
 const setStage=(src,index)=>{const stage=document.querySelector('.product-stage>img');if(stage)swapStage(stage,src);if(Number.isInteger(index)){galleryIndex=index;[...document.querySelectorAll('.product-thumbs button')].forEach((b,i)=>b.classList.toggle('active',i===index))}const current=Math.max(0,galleryIndex);const left=document.querySelector('.thumb-edge-left img');const right=document.querySelector('.thumb-edge-right img');if(left)left.src=galleryThumbs[(current-1+galleryThumbs.length)%galleryThumbs.length];if(right)right.src=galleryThumbs[(current+1)%galleryThumbs.length];};
 ...
 const initMotion=()=>{if(document.documentElement.dataset.motionBound)return;document.documentElement.dataset.motionBound='true';const nav=document.querySelector('.product-nav');const onScroll=()=>nav?.classList.toggle('header-scrolled',scrollY>80);addEventListener('scroll',onScroll,{passive:true});onScroll();
  ...
  const familySection=document.querySelector('.related-section');const cards=[...document.querySelectorAll('.related-track>a')];cards.slice(4).forEach(card=>card.remove());const familyNames=['SYLNC Enso V2 SQ','SYLNC Enso','SYLNC Barrel','SYLNC Enso Round'];const familyImages=[family[0],family[1],family[3],family[2]];cards.slice(0,4).forEach((card,i)=>{card.style.setProperty('--family-delay',(i*60)+'ms');const heading=card.querySelector('h3');const img=card.querySelector('img');if(heading)heading.textContent=familyNames[i];if(img){img.src=familyImages[i];img.alt=familyNames[i]}});
  ...
  requestAnimationFrame(()=>requestAnimationFrame(()=>document.documentElement.classList.add('motion-loaded')));initNativeCarousels();addEventListener('resize',()=>{syncSizeIndicator();carouselBindings.forEach(update=>update())},{passive:true})};
 const sync=()=>{
  const stage=document.querySelector('.product-stage>img'); if(stage&&!stage.dataset.synced){stage.src=defaultHero();stage.alt='Circulo pendant light';stage.dataset.synced='true'}
  ...
  const breadcrumb=document.querySelector('.product-breadcrumb');if(breadcrumb)breadcrumb.textContent='Home  /  Decorative  /  SYLNC  /  Circulo';
  const tag=document.querySelector('.product-tag');if(tag)tag.textContent='SYLNC COLLECTION · PENDANT LIGHT';
  const pageTitle=document.querySelector('.product-info h1');if(pageTitle)pageTitle.textContent='Circulo';
  const description=document.querySelector('.product-desc'); if(description) description.textContent='A sculptural pendant inspired by the quiet materiality of stone. Cymbal S pairs a hand-finished terrazzo shade with a softly diffused glass globe.';
  ...
  const swatches=[...document.querySelectorAll('.combination-swatches>button:not(.more-colours)')];swatches.forEach((button,index)=>{const variant=colourVariants[index];if(!variant)return;const dot=button.querySelector('i');if(dot){dot.style.setProperty('--finish-a',variant.finishA);dot.style.setProperty('--finish-b',variant.finishB)}const label=button.querySelector('span');if(label)label.textContent=variant.name;button.dataset.colorImageUrl=variant.colorImageUrl||''});
  const sizeOptions=document.querySelector('.size-options');if(sizeOptions&&!sizeOptions.dataset.circulo){sizeOptions.innerHTML=sizeVariants.map((size,index)=>'<button class="'+(index===0?'active':'')+'" data-pdf-code="'+size[1]+'">'+size[0]+'</button>').join('');sizeOptions.dataset.circulo='true';sizeOptions.classList.add('motion-segmented');requestAnimationFrame(()=>syncSizeIndicator())}
  const help=document.querySelector('.product-help');if(help){const link=help.querySelector('a');const icon=help.querySelector('svg');help.textContent='';if(icon)help.append(icon);help.append(document.createTextNode('Need bulk orders or custom solutions? '));if(link){link.textContent='Talk to us.';help.append(link)}}
  ...
  const collectionTitle=document.querySelector('.collection-band h2');if(collectionTitle)collectionTitle.innerHTML='Part of <em>SYLNC Collection</em>';
  const collectionCopy=document.querySelector('.collection-band>div>span');if(collectionCopy)collectionCopy.textContent='Inspired by the moon, NEOMA reimagines luminous white glass into timeless decorative lighting. Simple in form, refined in presence, each piece brings a soft, elegant glow to every space.';
  const relatedTitle=document.querySelector('.related-section>h2');if(relatedTitle)relatedTitle.textContent='The SYLNC Family';
 ...
 document.addEventListener('click',e=>{
  ...
  if(galleryArrow){e.preventDefault();if(galleryArrow.getAttribute('aria-disabled')==='true')return;const direction=galleryArrow.classList.contains('gallery-next')?1:-1;galleryIndex=Math.max(0,Math.min(gallery.length-1,galleryIndex+direction));setStage(gallery[galleryIndex],galleryIndex);scrollOneItem(document.querySelector('.product-thumbs'),'button',direction);return}
  const relatedArrow=e.target.closest('.related-arrow');
  if(relatedArrow){e.preventDefault();if(relatedArrow.getAttribute('aria-disabled')==='true')return;scrollOneItem(document.querySelector('.related-track'),'a',relatedArrow.classList.contains('related-next')?1:-1);return}
  ...
  const sizeChoice=e.target.closest('.size-options button');if(sizeChoice){e.preventDefault();[...sizeChoice.parentElement.children].forEach(button=>button.classList.toggle('active',button===sizeChoice));syncSizeIndicator();return}
