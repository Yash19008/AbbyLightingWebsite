      ...
      if (this.expanded === false) {
        if ($body.data('menu') == 'vertical-menu') {
          $('.nav-toggle').find('.toggle-icon')
           ...
           // $(document).find('.sidebar-header .logo-img').attr('src','');
      ...
      if (this.collapsed === false) {
        if ($body.data('menu') == 'vertical-menu') {
          $('.nav-toggle').find('.toggle-icon')
            ...
            // console.log(siteUrl+'/images/footer-logo.png');
            // $(document).find('.sidebar-header .logo-img img').attr('src',siteUrl+'/images/short_logo.png');
