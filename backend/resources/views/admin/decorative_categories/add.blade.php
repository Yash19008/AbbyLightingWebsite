...
<div class="content-wrapper">
    ...
    <div class="content-body">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('decorative_category_admin.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <div>
                                <input type="checkbox" class="js-switch" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} />
                                <small class="text-muted ml-1">If checked, this category will appear as a tab on the frontend product listing page.</small>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <button type="submit" class="btn btn-primary"><i class="ft-check"></i> Save Category</button>
                </form>
            </div>
        </div>
    </div>
