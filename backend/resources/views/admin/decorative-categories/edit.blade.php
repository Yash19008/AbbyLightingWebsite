                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="show_in_mega_dropdown" class="form-control">
                                <option value="1" {{ old('show_in_mega_dropdown', $category->show_in_mega_dropdown ?? 1) == 1 ? 'selected' : '' }}>Yes (Show in Mega Dropdown)</option>
                                <option value="0" {{ old('show_in_mega_dropdown', $category->show_in_mega_dropdown ?? 1) == 0 ? 'selected' : '' }}>No (Hide from Dropdown)</option>
                            </select>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            @if($category->image)
                                <div class="mb-2">
                                    <img src="{{ asset('uploads/decorative_categories/' . $category->image) }}"
                                         style="max-height: 100px; border: 1px solid #ccc; padding: 2px;" alt="Current image">
