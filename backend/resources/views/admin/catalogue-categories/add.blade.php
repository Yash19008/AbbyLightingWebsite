                ...
                <form action="{{ route('admin.catalogue-categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Architectural, Decorative, Outdoor" required value="{{ old('name') }}">
                        </div>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <textarea name="description" id="description" rows="3" class="form-control" placeholder="Short description about this catalogue category...">{{ old('description') }}</textarea>
                        </div>
