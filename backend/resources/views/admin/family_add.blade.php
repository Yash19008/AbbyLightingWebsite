                ...
                <form class="form-horizontal" id="{{$frn_id}}" novalidate action="javascript:;" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="inputName" class="col-sm-3 control-label">Family Name</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="image" name="image" class="form-control" placeholder="Image Name Here" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="offset-3 col-sm-8">
                                <button type="submit" class="btn btn-dark ">Add Family</button>
                            </div>
                        </div>
                    </div>
                </form>
