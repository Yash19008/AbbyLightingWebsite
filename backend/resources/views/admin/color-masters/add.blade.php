                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <input type="color" id="gradient_start_picker" class="form-control form-control-sm p-0 border mr-2" style="width: 40px; height: 38px; cursor: pointer;" value="{{ old('gradient_start', '#A84628') }}">
                                                <input type="text" id="gradient_start" name="gradient_start" class="form-control text-uppercase" value="{{ old('gradient_start', '#A84628') }}" maxlength="7">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <input type="color" id="gradient_end_picker" class="form-control form-control-sm p-0 border mr-2" style="width: 40px; height: 38px; cursor: pointer;" value="{{ old('gradient_end', '#000000') }}">
                                                <input type="text" id="gradient_end" name="gradient_end" class="form-control text-uppercase" value="{{ old('gradient_end', '#000000') }}" maxlength="7">
                                            </div>
                                        </div>
                                    </div>
                                </div>
