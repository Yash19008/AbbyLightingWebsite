                ...
                <form class="form-horizontal" id="{{$frn_id}}" novalidate action="{{@$action}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="inputName" class="col-sm-3 control-label">Icon<i class="text-danger">*</i></label>
                            <div class="col-sm-5 ">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" disabled placeholder="Upload Image" value="{{@$icon->icon}}">
                                    <input type="hidden" name="oldPhoto" value="{{@$icon->icon}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="name" name="name" class="form-control" placeholder="Name" value="{{ old('name',@$icon->name) }}">
                            </div>
                        </div>
