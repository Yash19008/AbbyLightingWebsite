                ...
                <form action="{{ route('admin.catalogues.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <select name="catalogue_category_id" id="catalogue_category_id" class="form-control" required>
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" {{ old('catalogue_category_id') == $category->id ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="title" id="title" class="form-control" placeholder="e.g. Architectural Master Catalogue, Symphony Collection" required value="{{ old('title') }}">
                        </div>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <textarea name="description" id="description" rows="3" class="form-control" placeholder="Brief overview or description of this catalogue...">{{ old('description') }}</textarea>
                        </div>

                        <div class="col-md-6 form-group">
                            <label for="cover_image" class="font-weight-bold">Cover Image <span class="text-danger">*</span></label>
                            <input type="file" name="cover_image" id="cover_image" class="form-control-file" accept="image/*" required onchange="previewImage(this, 'catalogue-cover-preview')">
                            <small class="form-text text-muted"><i class="fa fa-info-circle"></i> Vertical ratio recommended (e.g., 600 × 800 px or A4 ratio). Max 5MB.</small>
                            <div class="mt-2" id="catalogue-cover-preview" style="display: none;">
                                <img src="" style="max-height: 180px; border-radius: 4px; border: 1px solid #ddd; padding: 3px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                            </div>
                        </div>

                        <div class="col-md-6 form-group">
                            <label for="pdf_file" class="font-weight-bold">PDF Document File <span class="text-danger">*</span></label>
                            <input type="file" name="pdf_file" id="pdf_file" class="form-control-file" accept="application/pdf" required>
                            <small class="form-text text-muted"><i class="fa fa-file-pdf-o"></i> Upload the catalogue PDF file (Max 100MB). File size will be calculated automatically.</small>
                        </div>
                    ...
                    <div class="form-actions mt-4">
                        <button type="submit" class="btn btn-premium">
                            <i class="ft-save mr-1"></i> Save Catalogue
                        </button>
