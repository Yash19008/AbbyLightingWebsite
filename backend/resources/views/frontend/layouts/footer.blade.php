    ...
    <div class="figma-footer">
        <div class="footer-main">
            ...
            <nav class="footer-links footer-products" aria-label="Product links">
                ...
                <a class="footer-inspiration" href="/#news">Inspiration</a>
            </nav>
            ...
            <nav class="footer-links footer-company" aria-label="Company links">
                ...
                <a class="footer-mobile-legal" href="/privacy">Privacy Policy</a>
                <a class="footer-mobile-legal" href="/terms">Terms of Use</a>
                <a href="/fairs-events">Fairs &amp; Events</a>
            </nav>
        ...
        <div class="footer-base">
            <span>© {{ date('Y') }} Abby Lighting. All rights reserved.</span>
            <div class="footer-social">
                <a href="https://instagram.com/abbylighting" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                ...
                <a href="https://linkedin.com/company/abbylighting" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    <span class="footer-social-icon">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://facebook.com/abbylighting" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    <span class="footer-social-icon">
                ...
                <a href="https://youtube.com/@abbylighting" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                    <span class="footer-social-icon">
