        ...
        <div className="footer-base">
          ...
          <div className="footer-social">
            <a href="#" aria-label="Instagram">
              <span className="footer-social-icon footer-icon-desktop">
              ...
              <span className="footer-social-icon footer-icon-mobile">
                <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 1.4c4.75 0 8.6 3.85 8.6 8.6s-3.85 8.6-8.6 8.6S3.4 16.75 3.4 12 7.25 3.4 12 3.4zm0 3.8a4.8 4.8 0 100 9.6 4.8 4.8 0 000-9.6zm0 1.4a3.4 3.4 0 110 6.8 3.4 3.4 0 010-6.8z"
                  />
                </svg>
              </span>
            </a>
