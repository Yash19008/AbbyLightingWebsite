...
import { PlacesSection as PlacesSectionType } from '@/types/collection';

interface Props {
  placesSection: PlacesSectionType;
}
...
export default function PlacesSectionDynamic({ placesSection }: Props) {
  ...
  const items = placesSection.items || [];
